...
# local source
import MTNN as mtnn_defaults
import MTNN as torchconsts
...
class Model(nn.Module):
    ...
    Args:
        ...
        debug (bool): Sets logging during the the training.
            Logs are generated to the filepath specified in constants.py
    Attributes:
    ...
    def fit(self, dataloader, num_epochs, log_interval=1, checkpoint=False):
        """
        Train model given datasets. Calls Forward pass.
        Args:
